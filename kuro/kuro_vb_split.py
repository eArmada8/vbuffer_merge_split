...
# with 3dmigoto if one doesn't already exist. Specific version for Kuro no Kiseki using custom 3DMigoto
# with the drawindexedinstanced = auto command.
...
def split_vb_file_and_make_ini_file(meshname):
    ...
    ini_text.append(';drawindexedinstanced = auto\n')
    ini_text.append('\n')
